...
var initMap = function initMap() {
  ...
  var iconOptions = _leaflet.default.icon({
    iconUrl: 'img/svg/map-pin.svg',
    iconSize: [48, 48],
    iconAnchor: [24, 48]
  });
  var map = new window.L.Map(mapElement, mapOptions);
  if (!map) {
    return;
  }
  _leaflet.default.marker([55.816654, 37.636922], {
    icon: iconOptions
  }).addTo(map);
  _leaflet.default.tileLayer('http://{s}.google.com/vt/lyrs=p&x={x}&y={y}&z={z}', {
    minZoom: 10,
...
},{"../vendor/leaflet":17}],11:[function(require,module,exports){
"use strict";
...
var showMenu = function showMenu() {
  ...
  var menu = togglerElement.addEventListener('click', function () {
...
var initSliderReviews = function initSliderReviews() {
  ...
  var wrapperReviewsElement = document.querySelector('[data-wrapper="reviews"]');
