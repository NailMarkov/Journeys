...
},{"./modules/audio":2,"./modules/form-validate/form":4,"./modules/map":10,"./modules/menu":11,"./modules/modals/init-modals":12,"./modules/swiper":14,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAudios = void 0;
var initAudio = function initAudio(element) {
  var wrapperElement = document.querySelector('.wrapper-element');
  var buttonElement = wrapperElement.querySelector('[data-button="play"]');
  var radioElement = element.querySelector('.hero-card__radio');
  buttonElement.addEventListener('click', function () {
    radioElement.classList.toggle('hero-card__radio--active');
  });
};
var initAudios = function initAudios() {
  document.querySelectorAll('[data-audio]').forEach(initAudio);
};
exports.initAudios = initAudios;
...
var initSliderHero = function initSliderHero() {
  ...
  var initActiveSlides = function initActiveSlides() {
    if (!activeVideo) {
      return;
    }
    var activeSlides = swiperHero.slides[swiperHero.activeIndex];
    var activeBlock = activeSlides.querySelector('.hero-card');
    var activeVideo = activeBlock.querySelector('[data-video]');
    (0, _video.initVideo)(activeVideo);
  };
...
},{"./video":15}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initVideos = exports.initVideo = void 0;
