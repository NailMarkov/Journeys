...
},{"./modules/audio":2,"./modules/form-validate/form":4,"./modules/map":10,"./modules/menu":11,"./modules/modals/init-modals":12,"./modules/swiper":14,"./modules/video":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var initSliderHero = function initSliderHero() {
  ...
  var initActiveSlides = function initActiveSlides() {
    (0, _video.initVideo)();
    var activeSlide = swiperHero.slides[swiperHero.activeIndex]; // Находим текущий слайд
    var activePlayer = activeSlide.querySelector('[data-video]'); // Находим текущий плеер
