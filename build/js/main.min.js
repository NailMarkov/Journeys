...
exports.initSliderTours = exports.initSliderHero = void 0;
var initSliderHero = function initSliderHero() {
  var sliderElement = document.querySelector('[data-slider="hero"]');
  var swiperHero = new window.Swiper(sliderElement, {
    initialSLide: 1,
    slidesPerView: 1,
    pagination: {
...
var initSliderTours = function initSliderTours() {
  var sliderElement = document.querySelector('[data-slider="tours"]');
  var swiperTours = new window.Swiper(sliderElement, {
    navigation: {
