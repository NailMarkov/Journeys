...
var initAudio = function initAudio() {
  var buttonElement = document.querySelector('[data-button="play"]');
  var radioElement = document.querySelector('.hero-card__radio');
  var audio = buttonElement.addEventListener('click', function () {
...
var initMap = function initMap() {
  ...
  var map = _leaflet.default.map(mapElement, mapOptions);
...
var initSliderReviews = function initSliderReviews() {
  ...
  var wrapperElement = sliderReviewsElement.document.querySelector('.swiper-wrapper');
