...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _menu.initNav)();
  (0, _swiper.initSliderAdvantages)();
  (0, _swiper.initSliderGallery)();
  (0, _swiper.initSliderHero)();
  (0, _swiper.initSliderTours)();
  (0, _swiper.initSliderTraining)();
  (0, _swiper.initSliderReviews)();
  (0, _map.initMap)();
...
},{"./modules/form-validate/form":4,"./modules/map":10,"./modules/menu":11,"./modules/swiper":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAudio = exports.destroyAudios = void 0;
var initAudio = function initAudio(audioElement) {
  var buttonElement = audioElement.querySelector('[data-button="play"]');
...
var destroyAudio = function destroyAudio(containerAudioElement) {
  containerAudioElement.remove();
};
var destroyAudios = function destroyAudios() {
...
exports.destroyAudios = destroyAudios;
...
var initNav = function initNav() {
  ...
  var headerListElement = navElement.querySelector('.page-header__list');
  var togglerElement = navElement.querySelector('.page-header__toggle');
  var headerPhoneElement = navElement.querySelector('.page-header__wrapper');
  ...
  headerListElement.querySelectorAll('.page-header__link').forEach(function (linkElement) {
  ...
  var setNavHeight = function setNavHeight() {
    document.body.style.setProperty('--header-height', "".concat(navElement.clientHeight, "px"));
  };
...
exports.initSliderTraining = exports.initSliderTours = exports.initSliderReviews = exports.initSliderHero = exports.initSliderGallery = exports.initSliderAdvantages = void 0;
var _video = require("./video");
var _audio = require("./audio");
var initSliderHero = function initSliderHero() {
  var sliderHeroElement = document.querySelector('[data-slider="hero"]');
  var swiperHero = new window.Swiper(sliderHeroElement, {
    loop: true,
    initialSLide: 1,
    slidesPerView: 1,
    ...
    on: {
      slideChange: function slideChange(slider) {
        (0, _video.destroyVideos)();
        (0, _audio.destroyAudios)();
        var activeSlide = slider.slides[slider.activeIndex];
        var video = activeSlide.querySelector('[data-video]');
        if (video) {
          (0, _video.initVideo)(video);
        }
        var audio = activeSlide.querySelector('[data-audio]');
        if (audio) {
          (0, _audio.initAudio)(audio);
        }
      }
    }
  });
...
var initSliderTours = function initSliderTours() {
  var sliderToursElement = document.querySelector('[data-slider="tours"]');
  var swiperTours = new window.Swiper(sliderToursElement, {
    navigation: {
...
var initSliderTraining = function initSliderTraining() {
  var sliderTrainingElement = document.querySelector('[data-slider="training"]');
  var swiperTraining = new window.Swiper(sliderTrainingElement, {
    navigation: {
...
exports.initSliderTraining = initSliderTraining;
var initSliderReviews = function initSliderReviews() {
  var result = false;
  var sliderReviewsElement = document.querySelector('[data-slider="reviews"]');
  if (!sliderReviewsElement) {
    return result;
  }
  var wrapperReviewsElement = sliderReviewsElement.querySelector('[data-wrapper]');
  // wrapperReviewsElement.style.overflow = 'visible';

  var getMobileChange = function getMobileChange(event) {
    var overflofHide = event.matches ? wrapperReviewsElement.style.overflow = 'hidden' : wrapperReviewsElement.style.overflow = 'visible';
    return overflofHide;
  };
  ...
  var swiperReviews = new window.Swiper(sliderReviewsElement, {
    navigation: {
...
var initSliderAdvantages = function initSliderAdvantages() {
  var getDesktopChange = function getDesktopChange(event) {
    var result = event.matches ? swiperAdvantages : swiperAdvantages.destroy();
    return result;
  };
  var mediaQuery = window.matchMedia('(min-width: 1199px)');
  mediaQuery.addEventListener('change', getDesktopChange);
  var sliderAdvantagesElement = document.querySelector('[data-slider="advantages"]');
  var swiperAdvantages = new window.Swiper(sliderAdvantagesElement, {
    loop: true,
    navigation: {
...
var initSliderGallery = function initSliderGallery() {
  var sliderGalleryElement = document.querySelector('[data-slider="photogallery"]');
  var swiperGallery = new window.Swiper(sliderGalleryElement, {
    navigation: {
...
},{"./audio":2,"./video":13}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initVideo = exports.destroyVideos = void 0;
var _loadScript = require("../utils/load-script.js");
var scriptLoaded = false;
var playerIsReady = false;
var prepareElementByAnother = function prepareElementByAnother(oneElement, anotherElement) {
  ...
  var styles = anotherElement.getAttribute('style');
  if (styles) {
...
var initVideo = function initVideo(containerElement) {
  ...
  if (scriptLoaded) {
    ...
    (0, _loadScript.loadScript)('https://youtube.com/player_api', initPlayer, function () {
      return scriptLoaded = true;
    });
  }
};
exports.initVideo = initVideo;
var destroyVideo = function destroyVideo(containerDestroyElement) {
  var controlElement = containerDestroyElement.querySelector('[data-control]');
  var youtubeElement = containerDestroyElement.querySelector('[data-youtube]');
  var linkElement = document.createElement('a');
  prepareElementByAnother(linkElement, controlElement);
  linkElement.href = "https://youtube.com/embed/".concat(youtubeElement.dataset.youtube);
  containerDestroyElement.replaceChild(linkElement, controlElement);
  containerDestroyElement.classList.remove('is-active');
  var newYoutubeElement = document.createElement('div');
...
var destroyVideos = function destroyVideos() {
  var rootElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  rootElement.querySelectorAll('[data-video]').forEach(destroyVideo);
};
exports.destroyVideos = destroyVideos;

},{"../utils/load-script.js":16}],14:[function(require,module,exports){
"use strict";
